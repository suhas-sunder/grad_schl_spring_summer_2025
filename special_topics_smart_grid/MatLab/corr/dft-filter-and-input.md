...
phasor1 = complex(r1, i1);

% ----- Imaginary part of filter response (rotated 90°) -----

phasor3 = complex(i1, r1); % swap real/imag and rotate 90°
...
p3 = unwrap(angle(phasor3)) * (180/pi) + 90;
...
phasor2 = complex(r2, i2);

m2 = abs(phasor2);

p2 = unwrap(angle(phasor2)) * (180/pi);
